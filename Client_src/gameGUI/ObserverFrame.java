...
public class ObserverFrame {
	...
	public ObserverFrame(int type) throws RemoteException {
		...
		players = ClientRdF.getPlayerList();
	...
	private void initialize(String nickname, int type) throws RemoteException {
		...
		bonusF1 = new JTextField(""+ ClientRdF.getSt().getJolly(ClientRdF.idGame, players.get(0)));
		...
		try {
			bankF1 = new JTextField("$" + ClientRdF.getSt().getBank(ClientRdF.idGame, players.get(0)));
			...
			scoreF1 = new JTextField("$" + ClientRdF.getSt().getScore(ClientRdF.idGame, players.get(0)));
		...
		bonusF2 = new JTextField(""+ ClientRdF.getSt().getJolly(ClientRdF.idGame, players.get(1)));
		...
		try {			
			bankF2 = new JTextField("$"+ ClientRdF.getSt().getBank(ClientRdF.idGame, players.get(1)));
			...
			scoreF2 = new JTextField("$"+ ClientRdF.getSt().getScore(ClientRdF.idGame, players.get(1)));
		...
		bonusF3 = new JTextField(""+ ClientRdF.getSt().getJolly(ClientRdF.idGame, players.get(1)));
		...
		try {
			bankF3 = new JTextField("$"+ ClientRdF.getSt().getBank(ClientRdF.idGame, players.get(2)));
			...
			scoreF3 = new JTextField("$"+ ClientRdF.getSt().getScore(ClientRdF.idGame, players.get(2)));
		...
		try {
			mancheF = new JTextField("" + ClientRdF.getSt().getNmanche(ClientRdF.idGame));
